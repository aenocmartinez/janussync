    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        <div class="bg-white p-4 rounded-lg shadow-md flex flex-col justify-between">
            <div class="flex items-center">
                <i class="fas fa-server text-gray-600 text-4xl mr-3"></i>
                <div>
                    <h2 class="text-lg font-semibold text-gray-700">Conexión con Academusoft</h2>
                    <p class="text-sm text-gray-500">Estado actual del servicio</p>
                </div>
            </div>
            <div class="flex items-center mt-2">
                <span class="bg-green-100 text-green-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded-full">Conectado</span>
            </div>
        </div>
        <div class="bg-white p-4 rounded-lg shadow-md flex flex-col justify-between">
            <div class="flex items-center">
                <i class="fas fa-server text-gray-600 text-4xl mr-3"></i>
                <div>
                    <h2 class="text-lg font-semibold text-gray-700">Conexión con BrightSpace</h2>
                    <p class="text-sm text-gray-500">Estado actual del servicio</p>
                </div>
            </div>
            <div class="flex items-center mt-2">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        <div class="bg-white p-4 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
            ...
            <div class="relative w-32 h-32 mx-auto">
                <canvas id="completedTasksCanvas" class="w-32 h-32"></canvas>
                <div class="absolute inset-0 flex items-center justify-center">
                    <span class="text-2xl font-bold text-green-500">3/5</span>
                </div>
            </div>
        </div>
        <div class="bg-white p-4 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
            ...
            <div class="relative w-32 h-32 mx-auto">
                <canvas id="failedTasksCanvas" class="w-32 h-32"></canvas>
                <div class="absolute inset-0 flex items-center justify-center">
                    <span class="text-2xl font-bold text-red-500">2/5</span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full text-sm">
                <thead class="bg-gray-100">
                    <tr>
                        <th class="p-4 text-left font-semibold text-gray-600">Tarea</th>
                        <th class="p-4 text-left font-semibold text-gray-600">Estado</th>
                        <th class="p-4 text-left font-semibold text-gray-600">Fecha y Hora de Finalización</th>
                        <th class="p-4 text-left font-semibold text-gray-600">Frecuencia de Ejecución</th>
                        <th class="p-4 text-left font-semibold text-gray-600">Detalle</th>
                ...
                <tbody>
                    <tr class="border-b hover:bg-gray-50 transition-colors duration-300">
                        <td class="p-4">Creación de usuarios</td>
                        <td class="p-4"><span class="bg-green-100 text-green-800 text-xs font-semibold mr-2 px-2 py-0.5 rounded-full">Completado</span></td>
                        <td class="p-4">2024-07-02 14:30:00</td>
                        <td class="p-4"><span class="text-gray-700">Diaria</span></td>
                        <td class="p-4"><span class="text-lg font-bold text-gray-700">50</span> <span class="text-gray-500">usuarios creados</span></td>
                        <td class="p-4">
                    ...
                    <tr class="border-b hover:bg-gray-50 transition-colors duration-300">
                        <td class="p-4">Creación de cursos</td>
                        <td class="p-4"><span class="bg-green-100 text-green-800 text-xs font-semibold mr-2 px-2 py-0.5 rounded-full">Completado</span></td>
                        <td class="p-4">2024-07-03 10:15:00</td>
                        <td class="p-4"><span class="text-gray-700">Semanal</span></td>
                        <td class="p-4"><span class="text-lg font-bold text-gray-700">10</span> <span class="text-gray-500">cursos creados</span></td>
                        <td class="p-4">
                            <button class="bg-gray-200 text-gray-700 text-xs px-3 py-1 rounded hover:bg-gray-300 transition-colors duration-300">Ver Detalles</button>
                        </td>
                    </tr>
                    <tr class="border-b hover:bg-gray-50 transition-colors duration-300">
                        <td class="p-4">Calificación de un estudiante por cursos</td>
                        <td class="p-4"><span class="bg-red-100 text-red-800 text-xs font-semibold mr-2 px-2 py-0.5 rounded-full whitespace-nowrap">Tarea Fallida</span></td>
                        <td class="p-4">2024-07-04 13:20:00</td>
                        <td class="p-4"><span class="text-gray-700">Por corte (3 cortes por semestre)</span></td>
                        <td class="p-4"><span class="text-lg font-bold text-gray-700">N/A</span> <span class="text-gray-500">Error en la calificación</span></td>
                        <td class="p-4">
                    ...
                    <tr class="border-b hover:bg-gray-50 transition-colors duration-300">
                        <td class="p-4">Cierre de periodo</td>
                        <td class="p-4"><span class="bg-red-100 text-red-800 text-xs font-semibold mr-2 px-2 py-0.5 rounded-full whitespace-nowrap">Tarea Fallida</span></td>
                        <td class="p-4">2024-07-05 16:00:00</td>
                        <td class="p-4"><span class="text-gray-700">Semestral</span></td>
                        <td class="p-4"><span class="text-lg font-bold text-gray-700">N/A</span> <span class="text-gray-500">N/A</span></td>
                        <td class="p-4">
                            <button class="bg-green-500 text-white text-xs px-3 py-1 rounded hover:bg-green-600 transition-colors duration-300" onclick="openModal()">Reintentar</button>
                        </td>
                    </tr>
